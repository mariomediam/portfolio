const experience = [
      ...
      },
      {
        ...
        "measure": "18K",
        "subtitle": "Autorizaciones emitidas",
        "description": "Su implementación ha logrado simplificar procesos, facilitado la apertura rápida de negocios, estimulando la actividad económica y generando empleo.",
        "icon": "major"
      },
      {
      ...
      },
      {
        ...
        "description": "Lideré iniciativas exitosas para optimizar consultas SQL, transformando aquellas con tiempos de ejecución prolongados en operaciones eficientes que ahora se completan en menos de un segundo.",
        "icon": "minor"
      }
    ]
